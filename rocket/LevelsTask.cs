...
/*
Данный код представляет набор функций для создания уровней в игре, где игрок управляет ракетой.
В функции ControlRocket реализован алгоритм вычисления направления поворота для ракеты, чтобы она двигалась в сторону цели.
В остальных функциях определены различные уровни с разными условиями, такими как наличие гравитационных аномалий (белые и черные дыры), различные силы тяжести и т.д.
Каждый уровень представлен объектом типа Level, который содержит информацию о ракете, цели, гравитации и физике.
Функция CreateLevels возвращает набор уровней, которые можно использовать в игре.
*/
public class LevelsTask
{
    ...
    public static IEnumerable<Level> CreateLevels()
    {
        ...
        yield return GetLevelWithStandartPhisicsAndRocket("Up", new Vector(700, 500), (size, v) => new Vector(0, -(300 / (size.Y - v.Y + 300.0))));
